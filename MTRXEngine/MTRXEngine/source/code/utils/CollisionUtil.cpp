...
namespace mtrx
{
	namespace CollisionUtil
	{
		...
		bool BoxCapsuleCollision(const glm::vec3& center1, const glm::vec3& center2, const glm::vec3& A, const glm::vec3& B, float radius, const glm::vec3* axes, const float* halfExtents)
		{
			...
			std::pair<float, glm::vec3> pair = PhysicsUtil::MinDistanceSquaredPointSegment(A, B, center1);

			return SphereBoxCollision(pair.second, center1, radius, axes, halfExtents);
		}
