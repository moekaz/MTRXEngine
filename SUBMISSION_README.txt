...
- Documentation either via an html link by opening the index.html file or the pdf generated from the latex code (located in: documentation/ and the index.html is
 under documentation/html)
